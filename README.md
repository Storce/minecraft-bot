This simple docker compose runs a minecraft server and a Discord bot that tracks its logs and send some information like player logon to you desired Discord channel.
